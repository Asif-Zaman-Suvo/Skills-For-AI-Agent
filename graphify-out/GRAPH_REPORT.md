...
1. `Code Review and Quality` - 17 edges
2. `Test-Driven Development` - 14 edges
3. `Security and Hardening` - 14 edges
4. `Git Workflow and Versioning` - 14 edges
...
9. `Shipping and Launch` - 12 edges
...
Cohesion: 0.06
Nodes (30): Browser Testing with DevTools, code:block1 (RED                GREEN              REFACTOR), code:block14 (1. REPRODUCE: Navigate to the page, trigger the bug, screens), code:block15 (Main agent: "Spawn a subagent to write a test that reproduce), code:typescript (// RED: This test fails because createTask doesn't exist yet), code:typescript (// GREEN: Minimal implementation), code:block4 (Bug report arrives), code:typescript (// Bug: "Completing a task doesn't update the completedAt ti) (+22 more)
...
Cohesion: 0.07
Nodes (29): 1. Correctness, 2. Readability and simplicity, 3. Architecture, 4. Security, 5. Performance, Change descriptions (commits / PRs), Change sizing, Code Review and Quality (+21 more)
...
Cohesion: 0.22
Nodes (8): code:block1 (├── README.md), Contributing / customizing, Courtesy, License, Quick start, Repository layout, Skills for AI Agent, What’s included
...
## Knowledge Gaps
- **445 isolated node(s):** `Quick start`, `What’s included`, `code:block1 (├── README.md)`, `Contributing / customizing`, `Courtesy` (+440 more)
