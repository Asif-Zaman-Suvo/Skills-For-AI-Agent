...
Each skill is a **folder** containing `SKILL.md` with YAML frontmatter (`name`, `description`) and structured instructions the agent follows when the task matches that skill.
...
Rough flow (see [using-agent-skills](using-agent-skills/SKILL.md) for the full decision tree):
