...
1. Structures components, state, and styling using project conventions and a real design language.
2. Implements accessibility (focus, semantics, keyboard paths) as a default, not a retrofit.
3. Polishes layout, motion, and loading states so the UI feels intentional in real viewports.
4. Validates critical flows in the browser when runtime behavior matters.
